#############################################################################
# cmake build setup for CEDViewer
#
# For building CEDViewer with cmake type:
# (1) $ mkdir build
# (2) $ cd build
...
# Path to MarlinUtil
SET( MarlinUtil_HOME "${ILC_HOME}/MarlinUtil/v00-04"
...
# installation path for CEDViewer
#SET( CMAKE_INSTALL_PREFIX "/foo/bar" CACHE STRING "Where to install CEDViewer" FORCE )
